...
define('CMN_VERSION','1.0.0');

xecho('cmnblockcomputeexpected v'.CMN_VERSION."\n");

if (($argc < 3) || ($argc > 5)) {
  xecho("Usage: cmnblockcomputeexpected testnet blockfrom [blockto]\n");
  die(1);
}
...
$mysqli = new mysqli(CMNCTLMYSQLHOST, CMNCTLMYSQLUSER, CMNCTLMYSQLPASS, CMNCTLMYSQLDATABASE);

...
define('PROTOCOL_MAGIC',"\xa3\xd2\xa7\x03");
define('HRVERSION',"/Chaincoin Core:%s/CHC Ninja Port Checker:%s.%d/");
...
// Connect to P2P port of terracoind
...
class Node {
	...
	public function __construct($ip, $port = 13333, $timeout = 5, $versionid = '1.0.0', $sversionid = '0.12.2.4', $protver = PROTOCOL_VERSION, $prot_magic = PROTOCOL_MAGIC) {
